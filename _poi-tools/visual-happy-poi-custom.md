...
<div class="specification">
    <div class="box-spec">
        ...
        <p><strong>Chiều dài ống:</strong><span style="float: right;"> (Tùy chọn) </span></p>
        <p><strong>Đường kính ống:</strong><span style="float: right;"> (Tùy chọn)</span></p>
        <p><strong>Trọng lượng:</strong><span style="float: right;"> (Tùy chọn)</span></p>
    </div>
    <div class="box-spec">
        <div class="icon-spec">💡</div>
        <p><strong>Độ phân giải:</strong><span style="float: right;"> (Tùy chọn)</span></p>
        <p><strong>Số lượng LED:</strong><span style="float: right;" > (Tùy chọn)</span></p>
        <p><strong>Độ sáng:</strong><span style="float: right;"> 1100 lm</span></p>
    </div>
    <div class="box-spec">
        <div class="icon-spec">⚙️</div>
        <p><strong>Độ dài vệt sáng:</strong><span style="float: right;"> (Tùy chọn)</span> </p>
